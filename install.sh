...
echo "🔧 INSTANT CHMOD 777 FIX"# KONAČNI UBUNTU 20.04 MUMUDVB INSTALLER 

echo "======================="# ZA ROOT USER - REŠAVA SVE PROBLEME!



# FORCE 777 na sve u current directoryset -e  # Exit on any error

chmod 777 * 2>/dev/null || true

chmod +x * 2>/dev/null || trueecho "🚀 KONAČNI UBUNTU 20.04 MUMUDVB INSTALLER (ROOT MODE)"

echo "====================================================="

echo "✅ Permissions fixed!"echo "Date: $(date)"

echo ""echo "User: $(whoami)"

echo "🚀 Starting installer..."echo "Ubuntu: $(lsb_release -ds 2>/dev/null || echo 'Unknown')"

./master-panel-install.shecho ""
